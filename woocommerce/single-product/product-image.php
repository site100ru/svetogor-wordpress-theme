...
<div id="<?php echo esc_attr($carousel_id); ?>" class="carousel slide" data-bs-ride="false" data-bs-interval="false">
    <div class="carousel-inner rounded">
        <?php foreach ($attachment_ids as $index => $attachment_id): ?>
            ...
            <div class="carousel-item gallery-product-wrapper gallery-<?php echo esc_attr($product_id); ?>-wrapper <?php echo $index === 0 ? 'active' : ''; ?>">
                <a href="#" class="gallery-product gallery-<?php echo esc_attr($product_id); ?> bg-transparent" onclick="galleryOn('gallery-<?php echo esc_attr($product_id); ?>');">
