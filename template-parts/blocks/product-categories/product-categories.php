 ...
 * добавлена сортировка по menu_order как в админке
 */
    ...
    <div class="container">
        <?php if ($show_section_title): ?>
            <div class="section-title text-center">
                ...
                <img width="62" height="14" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/img/ico/points.svg" alt="Декоративные точки" class="img-fluid">
            </div>
        <?php endif; ?>
