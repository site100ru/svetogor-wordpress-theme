                        ...
                        <ul class="navbar-nav align-items-center justify-content-between w-100">
                            ...
                            <li class="nav-item me-3 me-md-1 me-xl-3">
                                <div
                                    ...
                                    <img width="24" height="24" loading="lazy" src="<?php echo esc_url(get_contact_icon_url('location_icon', 'location-ico.svg')); ?>" alt="Адрес">
                                    <span>
                            ...
                            <li class="nav-item me-3 me-md-1 me-xl-3">
                                <a href="mailto:<?php echo esc_attr(get_company_email()); ?>"
                                    ...
                                    <img width="24" height="24" loading="lazy" src="<?php echo esc_url(get_contact_icon_url('email_icon', 'email-ico.svg')); ?>" alt="Email">
                            ...
                            <li class="nav-item me-3 me-md-1 me-xl-3">
                                <button class="nav-link d-flex align-items-center gap-3 gap-md-2 gap-xl-3 lh-1" data-bs-toggle="modal"
                                    ...
                                    <img width="24" height="24" loading="lazy" src="<?php echo esc_url(get_contact_icon_url('callback_icon', 'callback-ico.svg')); ?>" alt="Обратный звонок">
                                    Обратный звонок
                                </button>
                            </li>
                            ...
                            <li class="nav-item me-3 me-md-1 me-xl-3">
                                ...
                                <button class="nav-link d-flex align-items-center gap-3 gap-md-2 gap-xl-3 lh-1" data-bs-toggle="modal"
                                    ...
                                    <img width="24" height="24" loading="lazy" src="<?php echo esc_url(get_contact_icon_url('calculator_icon', 'calculator.svg')); ?>" alt="Калькулятор">
                            ...
                            ?>
                                <li class="nav-item ms-auto me-3 me-md-1 me-xl-3">
                                    <a class="top-menu-tel nav-link gap-3"
                                        ...
                                        <img width="24" height="24" loading="lazy" src="<?php echo esc_url(get_contact_icon_url('global_phone_icon', 'mobile-phone-ico.svg')); ?>" alt="Телефон">
